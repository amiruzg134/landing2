                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="blog-details__content">
                            <div class="blog-details__date">27 Juni 2022</div>
                            <div class="blog-details__meta">
                                <a href="#" class="blog-details__meta-link">VENDA AYUNG P. - Penyuluh Kehutanan</a>
                            </div>
                            <h3 class="blog-details__title">MENGENAL CANTIGI, FLORA ENDEMIK TAHURA RADEN SOERJO</i></h3>
                            <p class="blog-details__text">
                                Tahura Raden Soerjo merupakan kawasan konservasi dengan 4 tipe ekosistem, yaitu:
                                <ol>
                                    <li>Hutan hujan tropis dataran rendah (berada pada ketinggian 500 – 1.000 mdpl)</li>
                                    <li>Hutan pegunungan bawah/sub montana (berada pada ketinggian 1.000 – 1.500 mdpl)</li>
                                    <li>Hutan pegunungan atas/montana (berada pada ketinggian 1.500 – 2.400 mdpl)</li>
                                    <li>Hutan sub alpin (berada pada ketinggian lebih dari 2.400 mdpl)</li>
                                </ol>
                            </p>
                            <p class="blog-details__text">
                            ...
                            <div class="blog-details__image" style="margin:30px 0">
                                <img src="../images/berita/img-126.jpg" />
                            </div>
                            <div class="blog-details__image" style="margin:30px 0">
                                <img src="../images/berita/img-127.jpg" />
                            </div>
                            <br>
