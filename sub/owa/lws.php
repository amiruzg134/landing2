							...
							<div id="tour-slide">
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/owa-lws/Picture5.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
								<div class="slide">
									<div class="bg-stretch">
						...
						<div class="height col-md-6 text-col">
							<div class="holder">
								...
								<div class="description">
									<p>
										Loka Wisata Surya adalah objek wisata edukasi untuk pengenalan ekosistem flora dan fauna di hutan pegunungan. Yang membuat Loka Wisata Surya semakin menarik untuk dikunjungi adalah karena objek wisata ini memiliki keindahan alam yang begitu asri dan sejuk sehingga cocok menjadi tempat refreshing. Terdapat beberapa spot  antara lain, air terjun Banyu Adem, air terjun Slumprit, camping ground, taman rusa, dan arboretum. Adapun aktivitas yang dapat dilakukan pengunjung meliputi birdwatching, pendakian gunung Pundak, family camping, family gathering, outbound, fun hiking, dan forest bathing. Pengunjung tidak hanya bisa menikmati kawasan ini untuk wisata edukasi, melainkan juga bisa melakukan wisata pendakian ke Gunung Pundak yang memiliki ketinggian 1.585 mdpl. Tersedia lahan parkir yang luas dan penjagaan selama 24 jam
									</p>
								</div>
								<ul class="reviews-info">
                                    ...
                                    <li style="width: 100%">
                                    	<div class="info-left" style="width: 100%">
											...
											<ul>
												<li>Senin - Minggu : 08.00 - 19.00 WIB</li>
											</ul>
										</div>
                                    </li>
                                </ul>
