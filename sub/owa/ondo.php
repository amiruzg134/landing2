					...
					<div class="same-height two-columns row">
						<div class="height col-md-6">
							...
							<div id="tour-slide">
								...
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/owa-watu-ondo/Picture9.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
							</div>
						</div>
						<div class="height col-md-6 text-col">
							<div class="holder">
								...
								<div class="description">
									<p> Air terjun (Coban, bahasa Jawa) Watu Ondo atau Coban Kembar Watu Ondo, terletak di Taman Hutan Raya Raden Soerjo, tepatnya di lereng Gunung Welirang. Terdapat 2 air terjun dengan 2 sumber mata air yang berbeda. Sejarah nama Coban Watu Ondo merujuk kepada jalur turunan menuju lokasi air terjun berupa anak tangga yang tersusun dari bebatuan. Adapun penyematan kata kembar merujuk pada adanya dua buah air terjun yang saling berhadapan. </p>
									<p>Terdapat nilai sejarah di lokasi Coban Kembar Watu Ondo yang dibuktikan dengan keberadaan dua buah goa yang berada di antara Air Terjun Kembar tersebut. Dua buah goa tersebut adalah goa peninggalan masa penjajahan Jepang yang digunakan sebagai tempat persembunyian, penyimpanan makanan dan persenjataan tentara Jepang. Masyarakat sekitar menyebut goa tersebut dengan nama Goa Jepang. Namun kondisi goa saat ini tidak terawat dan tertutupi oleh rerumputan.</p>
								</div>
