					...
					<div class="same-height two-columns row">
						<div class="height col-md-6">
							...
							<div id="tour-slide">
								...
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/pundak/Picture2.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
							</div>
						</div>
						<div class="height col-md-6 text-col">
							<div class="holder">
								...
								<div class="description">
									<p>
										Gunung Pundak memiliki jalur pendakian yang  bersahabat bagi pendaki pemula dengan ketinggian 1.585 mdpl. Hanya dibutuhkan waktu ± 2 (dua) jam untuk sampai di puncak gunung. 
									</p>
									<p>
										Pendaki akan disuguhkan jalur yang cukup landai saat mencapai puncak. Para pendaki dapat menikmati hamparan ilalang dengan background Gunung Penanggungan di sebelah utara, Gunung Welirang di sebelah selatan, serta pegunungan Anjasmoro di sebelah barat.	
									</p>
								</div>
