...
<meta charset="utf-8">
    ...
    <title>Air Terjun Tretes - Tahura Raden Soerjo</title>
    <!-- favion -->
				...
				<section class="container-fluid trip-info">
					<div class="same-height two-columns row">
							...
							<div id="tour-slide">
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/owa-tretes/img-01.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/owa-tretes/img-05.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
								<div class="slide">
									<div class="bg-stretch">
										<img src="../../images/owa/owa-tretes/Picture7.jpg" alt="image descriprion" height="1104" width="966">
									</div>
								</div>
							</div>
						</div>
						<div class="height col-md-6 text-col">
							<div class="holder">
								<h1 class="small-size">Air Terjun Tretes</h1>
								<div class="description">
									<p> Sensasi udara sejuk pegunungan dan pemandangan air terjun setinggi 158 meter menjadikan para pengunjungnya betah berlama-lama di lokasi wisata ini. Meski jaraknya cukup jauh, Air Terjun Tretes yang disebut-sebut tertinggi di Jawa Timur ini tak pernah sepi pengunjung. Untuk mencapai lokasi wisata ini, pengunjung dapat menuju Desa Galengdowo, Kecamatan Wonosalam yang berjarak sekitar 30 km dari pusat Jombang kota. Dinamakan Air Terjun Tretes Pengajaran karena lokasinya berada di ujung Desa Galengdowo tepatnya Dusun Pengajaran. Dari cerita masyarakat, Air Terjun Tretes dipercaya sebagai tempat pertemuan dua pasangan, yakni Pengeran Barongkusumo dari Gunung Anjasmoro dan Dewi Anjarwati dari Gunung Lawu. Bahkan, dulunya air terjun ini juga dipakai mandi Mahapatih Gajah Mada. </p>
								</div>
								<ul class="reviews-info">
                                    <li style="width: 100%">
                                    	<div class="info-left" style="width: 100%">
											...
											<ul>
												<li>Wisatawan WNI : Rp. 10.000 / orang <small>( + asuransi Rp. 1.000 )</small></li>
				...
				<div class="tab-container">
					...
					<div class="container tab-content trip-detail">
						...
						<div role="tabpanel" class="tab-pane" id="tab02">
							<div class="row">
								<div class="col-md-12">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79806.12720699588!2d112.42413027043276!3d-7.763854930878165!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7864acdcc094ef%3A0xa26c49ca5aca1b08!2sAir%20Terjun%20Tretes%20Kembar%20Jarak!5e1!3m2!1sid!2sid!4v1582600314002!5m2!1sid!2sid" width="100%" height="500" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                                </div>
							</div>
						</div>
						...
						<div role="tabpanel" class="tab-pane" id="tab03">
							<ul class="row gallery-list has-center">
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-01.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-01.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-02.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-02.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-03.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-03.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-04.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-04.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-05.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-05.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-06.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-06.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
								...
								<li class="col-sm-6">
									<a class="fancybox" data-fancybox-group="group" href="../../images/owa/owa-tretes/img-07.jpg">
										<span class="img-holder">
											<img src="../../images/owa/owa-tretes/img-07.jpg" height="750" width="450" alt="image description">
										</span>
										<span class="caption">
											<span class="centered"></span>
										</span>
						...
						<div role="tabpanel" class="tab-pane active" id="tab05">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="detail">
										<p>Udah sering denger daerah wisata Tretes belum? Ternyata di Tretes ada air terjunnya juga lho. Perlu kalian tau nih teman-teman, Air Terjun Tretes Merupakan air terjun tertinggi di Jawa Timur dengan ketinggian ± 170 m, terletak di kawasan Tahura Raden Soerjo, yang secara administratif berada di Desa Galeng Dowo Kec. Wonosalam, Kabupaten Jombang pada 7° 46’ 20,867” – 7° 46’ 41,543 LS dan 112° 23’ 39,485” – 112° 24’ 23,804” BT. Air terjun ini merupakan hulu sungai Sumber Watu Bonakah, memiliki panorama alam indah yang berada di Gunung Jurung Guah. Lokasi Air Terjun ada di ketinggian 1.172 mdpl.</p>
									</div>
								</div>
								<div class="col-md-12" style="margin-top: 20px">
									<div class="detail">
